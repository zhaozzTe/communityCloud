...
export const addServer = params => http({ url: `http://one-tech.cn:88/zh/api/v1/requires/add`, loading: true, params, method: 'post' });//添加服务需求
...
export const attend = params => http({ url: `http://one-tech.cn:88/zh/api/v1/attend/attend`, params, loading: true, method: 'post' });//参与
